...
let names: string[] = ["Alan", "Loki", "Odin"];    // String array
...
let person: [string, number] = ["Alan", 30];      // Declare tuple with string and number
let worker: [string, number, boolean] = ["Martinez", 25, true];  // Tuple with 3 elements
